...
from src.domain.exceptions import DuplicateMessageException, ChatNotFoundException, UserNotFoundException
...
class SendMessageUseCase:
    ...
    async def execute(self, chat_id: int, sender_id: int, text: str, message_id: str):
        ...
        if not user:
            raise UserNotFoundException("Запрошенный пользователь не существует")
        ...
        await self.redis_client.setex(cache_msg_key, 60, True)
